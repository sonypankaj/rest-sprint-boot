package com.example.javaspringtbootjpa;

import com.example.javaspringtbootjpa.business.TourPackageService;
import com.example.javaspringtbootjpa.business.TourService;
...
public class JavaSpringtbootJpaApplication implements CommandLineRunner {
  ...
  public static void main(String[] args) {
    ...
    SpringApplication.run(JavaSpringtbootJpaApplication.class, args);
  }
  ...
  /*
   * Helper to import ExploreCalifornia.json
   */
  record TourFromFile(
      String packageName,
      String title,
    ...
    static List<TourFromFile> read(String fileToImport) throws IOException {
      return new ObjectMapper()
          .readValue(new File(fileToImport), new TypeReference<List<TourFromFile>>() {});
    }
  }
}
